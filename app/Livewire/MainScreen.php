...
class MainScreen extends Component
{
    ...
    private function simpleFacilities(array $locationData): array
    {
        ...
        $items = [
            ...
            ['group' => '育成', 'name' => '冒険者訓練所', 'icon_image' => 'icon/icon_291.webp', 'icon' => '⚔️', 'desc' => "奥義を{$trainingTurns}ターンの模擬戦で試す", 'action' => '入る', 'route' => 'training-ground.index', 'is_post' => false, 'status' => 'active'],
    ...
    )
    {
        ...
        $townFacilities = [
            ...
            ['category' => '育成', 'name' => '冒険者訓練所', 'symbol_image' => 'icon/icon_291.webp', 'desc' => "奥義を安全な{$trainingTurns}ターンの模擬戦で試す", 'details' => ['通常戦・ボス戦セット', '戦果・報酬なし'], 'bg_image' => 'bg-battle.webp', 'status' => 'active', 'action' => '訓練する', 'route' => 'training-ground.index', 'is_post' => false],
            ...(!$isFerdiaSimpleBase ? [
