...
final class NationRaidParticipation extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'is_recently_active_snapshot' => 'boolean',
            'raid_benefits_held_snapshot' => 'boolean',
            'published_active_count' => 'integer',
            'started_active_count' => 'integer',
            'reference_active_count' => 'integer',
            'resolved_sorties' => 'integer',
            'readiness_percent_snapshot' => 'integer',
            'free_sortie_daily_grant_snapshot' => 'integer',
            'free_sortie_balance_cap_snapshot' => 'integer',
            'free_sortie_balance' => 'integer',
            'free_sortie_last_granted_day' => 'integer',
            'free_sorties_used' => 'integer',
            'free_sorties_refunded' => 'integer',
