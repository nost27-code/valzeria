...
final class JobArtV2Rank5V6Catalog
{
    ...
    private const SPECS = [
        ...
        7 => ['name' => '癒しの祈り', 'power' => null, 'trigger_mode' => 'scheduled', 'effect_text' => '攻撃なし。精神150%分、自分のHPを回復する。その後、次の自分の行動開始まで、次に受ける直接攻撃のダメージを15%軽減する（1回）'],
        ...
        10 => ['name' => 'ホーリーブレイド', 'power' => 100, 'trigger_mode' => 'scheduled', 'effect_text' => '威力100%の物理ダメージ。最大HP7%分、自分のHPを回復する。その後、次の自分の行動開始まで、次に受ける直接攻撃のダメージを15%軽減する（1回）'],
        11 => ['name' => '居合斬り', 'power' => 100, 'trigger_mode' => 'scheduled', 'effect_text' => '受け流し率+20%。受け流しに成功した場合、次の自分の行動開始まで被ダメージ15%軽減'],
        ...
        15 => ['name' => 'ガーディアンブロウ', 'power' => 100, 'trigger_mode' => 'reactive', 'effect_text' => '被ダメージ16%軽減。対奥義/大技予告中は専用防御35%軽減へ切替'],
        ...
        29 => ['name' => '賢者の結界', 'power' => 100, 'trigger_mode' => 'scheduled', 'effect_text' => '次の自分の行動開始まで被ダメージ18%軽減'],
        ...
        36 => ['name' => '神罰の槌', 'power' => 100, 'trigger_mode' => 'scheduled', 'effect_text' => '相手の魔力を−15%する（3ターン）。次の自分の行動開始まで被ダメージ15%軽減'],
