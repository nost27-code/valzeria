    ...
    public function data(SavedBattle $battle, NationRaidEvent $event, NationRaidParticipation $participation): array
    {
        ...
        return [
            ...
            'event_snapshot' => [
                ...
                'sortie_cost_type' => $admission['cost_type'] ?? NationRaidSortieCostService::TYPE_STAMINA,
                'free_balance_before' => $admission['free_balance_before'] ?? null,
                'free_balance_after' => $admission['free_balance_after'] ?? null,
                'free_daily_grant' => $admission['free_daily_grant'] ?? null,
                'free_balance_cap' => $admission['free_balance_cap'] ?? null,
