...
class FacilityConfig
{
    const TOWN_ENTRIES = [
        ...
        ['slug' => 'blacksmith',        'label' => '鍛冶屋',      'default_name' => '鍛冶屋',      'default_desc' => '強化石を使って武器を+1〜+3へ強化する',                 'default_icon' => 'facilities/facility_blacksmith_300.webp'],
        ...
        ['slug' => 'material_exchange', 'label' => '素材交換所',  'default_name' => '素材交換所',  'default_desc' => '素材を別素材や回復アイテムへ交換・調合する',             'default_icon' => 'facilities/facility_material_exchange_300.webp'],
        ...
        ['slug' => 'supply_merchant',   'label' => '補給商会',    'default_name' => '補給商会',    'default_desc' => '輝石で冒険支援アイテムを購入できる',                   'default_icon' => 'facilities/hokyu_symbol.webp'],
    ];
    ...
    const SIMPLE_ONLY_ENTRIES = [
        ...
        ['slug' => 'seal_book',         'label' => '印図鑑',      'default_name' => '印図鑑',      'default_desc' => '集めた印の永続効果を確認する',          'default_icon' => 'icon/icon_013.webp'],
    ...
    const HOME_ENTRIES = [
        ...
        ['slug' => 'job_arts',      'label' => '奥義',        'default_name' => '奥義',        'default_desc' => '習得した奥義を最大3つまでセットする',         'default_icon' => 'icon/icon_041.webp'],
        ['slug' => 'titles',        'label' => '称号',        'default_name' => '称号',        'default_desc' => '獲得した称号を確認する',                     'default_icon' => 'menu/menu_titles.webp'],
