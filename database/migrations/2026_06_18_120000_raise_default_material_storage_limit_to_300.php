...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('characters')
            ->where('material_storage_limit', '<', 300)
            ->update(['material_storage_limit' => 300]);
    }
    ...
    public function down(): void
    {
        ...
        if (in_array(DB::getDriverName(), ['mysql', 'mariadb'], true)) {
            DB::statement('ALTER TABLE characters MODIFY material_storage_limit INT UNSIGNED NOT NULL DEFAULT 200');
        }
    }
};
