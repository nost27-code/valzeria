...
{
    private const PENDING_HIDDEN_JOB_KEYS = [
        'holy_sword_general',
        'black_flame_knight',
        'azure_sky_dragoon',
        'star_reader_sage',
        ...
        'sanctuary_guardian',
        'golden_alchemist',
        'thunder_fist_overlord',
        'battlefield_tactician',
        'crown_sword_knight',
        'black_crown_magic_knight',
        'dragon_crown_lance_general',
        'star_crown_sage',
        'shadow_crown_hunter',
        'steel_crown_machina_sage',
        'holy_crown_guardian',
        'gold_crown_alchemist',
        'thunder_crown_fist_saint',
        'war_crown_commander',
        'dawn_hero',
        'black_moon_executor',
        'star_heaven_sage',
        ...
        'skyward_sword_emperor',
        'black_flame_demon_emperor',
        'world_tree_sage',
        'shadow_funeral_king',
        'star_sea_voyager',
        'star_law_priest',
    ...
    public function run(): void
    {
        ...
        foreach ($lines as $line) {
            ...
            $jobData = [
                ...
                'is_active' => ! in_array($key, self::PENDING_HIDDEN_JOB_KEYS, true),
    ...
    private function seedEquipmentPermissions(): void
    {
        ...
        $weaponPermissions = [
            ...
            '盾聖' => ['sword', 'spear', 'staff'],
            '魔弓将' => ['bow', 'staff', 'magic_device', 'gun'],
            '詩聖' => ['staff', 'bow', 'magic_device'],
            '薬聖' => ['staff', 'dagger', 'magic_device'],
            '戦略王' => ['sword', 'staff', 'magic_device', 'gun'],
            '大錬金術師' => ['magic_device', 'staff', 'gun', 'dagger'],
        ...
        $armorPermissions = [
            ...
            '盾聖' => ['robe', 'light_armor', 'heavy_armor'],
            '魔弓将' => ['clothes', 'robe', 'cloak', 'light_armor'],
            '詩聖' => ['clothes', 'robe', 'cloak'],
            '薬聖' => ['clothes', 'robe', 'cloak', 'light_armor'],
            '戦略王' => ['clothes', 'cloak', 'light_armor', 'heavy_armor'],
            '大錬金術師' => ['clothes', 'robe', 'cloak', 'light_armor'],
