...
final class JobArtV2CanonicalSelfBuffRuntimeAuditTest extends TestCase
{
    ...
    public function test_every_canonical_self_buff_matches_runtime_in_all_battle_contexts_and_origins(): void
    {
        ...
        $this->assertCount(34, $canonicalArts, 'A new canonical self buff must enter this runtime audit.');
        $sharedTemplateArts = [];
        ...
        $this->assertCount(22, $sharedTemplateArts, 'Shared-template arts must stay inside the canonical runtime audit.');
    }
