...
class JobArtV2CardDescriptionCatalogTest extends TestCase
{
    ...
    public function test_catalog_is_the_self_contained_192_art_crown_scope(): void
    {
        ...
        $this->assertSame(
            '322d60f4aef0e7ec9a3ec2f13e33bec3b5ec4783a565c83f018d3bd7c73c689d',
    ...
    {
        $expected = [
            '6:5:天測の陣' => "星印を-4し、相手に威力145%の魔力ダメージを与える。その後、天測の場を5ラウンド展開する。この戦技で展開した天測の場は、この攻撃自身には適用されない。\n\n（天測の場：展開した側の命中率を+5ポイントし、系譜リソースを獲得する際の獲得量を+1する。）",
            '17:9:狩猟の完成' => '狩猟印を-12し、相手に威力255%の物理ダメージを与える。相手の標的印が2段階以上ある場合、標的印を2段階消費し、最終ダメージを1.50倍にする。',
            '19:9:魂喰らい' => '冥蝕を-12し、相手に威力255%の魔力ダメージを与える。与えたダメージの35%分、自分のHPを回復し、相手の現在SPを最大SPの10%分減らす。',
            ...
            '33:9:崩落' => '崩しを-12し、相手に威力315%の物理ダメージを与える。相手の解除可能な強化を1つ解除し、5ターンの間、相手の防御と精神を-25%する。',
