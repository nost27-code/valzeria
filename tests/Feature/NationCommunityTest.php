...
SQL);
    ...
    public function test_livewire_supports_founding_application_approval_and_coming_soon_without_backend_write(): void
    {
        ...
        $nationScreen
            ...
            ->assertSeeHtml('data-nation-header-stat-cell="members"')
            ->assertSeeHtml('data-nation-header-stat-cell="development"')
            ->assertSeeHtml('data-nation-header-stat-cell="recruitment"')
