...
$remoteCommand = "chmod 700 '$incomingDir/reset-staging-database.sh' && DEPLOY_ROOT='$deployRoot' DEPLOY_PHP_BINARY='$phpBinary' bash '$incomingDir/reset-staging-database.sh'"
