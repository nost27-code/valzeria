...
return [
    'counter' => [
        ...
        'cycle' => [
            ...
            'build_name' => '剣勢連環',
            'purpose' => '汎用・長期戦',
            'description' => '自己強化を長く維持し、始動と連携を循環させて攻め続けます。',
            'tags' => ['長期向け', '反撃循環'],
            'variants' => [
        ...
        'tactical' => [
            ...
            'build_name' => '王冠迎撃',
            'purpose' => '物理ボス・PvP',
            'description' => '相手の攻撃を下げ、大技軽減と受け流し反撃で押し返します。',
            'tags' => ['大技対策', '物理対策'],
            'variants' => [
    ...
    'pierce' => [
        ...
        'cycle' => [
            ...
            'build_name' => '蒼天連環',
            'purpose' => '長期ボス',
            'description' => '構えを維持しながら、防御無視と自己強化を繰り返します。',
            'tags' => ['長期向け', '構え維持'],
            'variants' => [
    ...
    'field' => [
        ...
        'tactical' => [
            ...
            'build_name' => '封式聖堂',
            'purpose' => '予告大技・耐久',
            'description' => '大技の固有追加効果を抑え、回復・SP・浄化・軽減で立て直します。',
            'tags' => ['大技対策', '立て直し'],
            'variants' => [
    ...
    'guard' => [
        ...
        'tactical' => [
            ...
            'build_name' => '大技迎撃',
            'purpose' => '予告大技・PvP',
            'description' => '敵の攻撃を下げ、大技軽減と奥義軽減を使い分けて受け切ります。',
            'tags' => ['大技対策', '大幅軽減'],
            'variants' => [
