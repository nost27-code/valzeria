...
特定の職業・ランクで習得した戦技を、通常戦用・ボス戦用・PvP用にそれぞれ最大5つまでセットできます。基礎発動率は始動50%・連携55%・奥義60%です。SPなどの発動条件を満たした候補を、セットごとの方針にしたがって自動判定します。</p>
...
<p><strong>戦技（ジョブアーツ）：</strong><br>
現在の職業で習得した戦技と、マスター済みの職業から継承した戦技を、通常戦用・ボス戦用・PvP用にそれぞれ最大5つまでセットできます。基礎発動率は始動50%・連携55%・奥義60%です。セットごとに積極・通常・温存の方針を設定でき、戦技の発動はSPを消費します。</p>
HTML,
        ],
        [
            'slug' => 'new_dungeons',
