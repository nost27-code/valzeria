...
特定の職業・ランクで習得した奥義を、通常戦用とボス戦用にそれぞれ最大3つまでセットできます。SPが十分にある場合、各スロットの方針にしたがって自動発動します。</p>
...
<p><strong>奥義（ジョブアーツ）：</strong><br>
現在の職業で習得した奥義と、マスター済みの職業から継承した奥義を、通常戦用とボス戦用にそれぞれ最大3つまでセットできます。各スロットには積極・通常・温存の方針を設定でき、奥義の発動はSPを消費します。</p>
HTML,
        ],
        [
            'slug' => 'new_dungeons',
