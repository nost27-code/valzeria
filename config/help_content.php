...
<ul>
    ...
    <li><strong>SP</strong>：奥義（特殊スキル）を使うために消費する</li>
    <li><strong>攻撃</strong>：物理ダメージに影響</li>
    <li><strong>防御</strong>：受けるダメージを軽減</li>
    <li><strong>魔力</strong>：魔法ダメージに影響</li>
    <li><strong>精神</strong>：魔法防御に影響</li>
    <li><strong>敏捷</strong>：先制行動に影響</li>
    <li><strong>運</strong>：クリティカルや特殊効果に影響</li>
</ul>
...
自分と敵が交互に攻撃するターン制で進みます。敏捷の値が高いほど先に行動できます。</p>
<p><strong>戦技（ジョブアーツ）：</strong><br>
特定の職業・ランクで習得した戦技を、通常戦用・ボス戦用・PvP用・レイド用にそれぞれ最大5つまでセットできます。基礎発動率は始動50%・連携55%・奥義60%です。SPなどの発動条件を満たした候補を、セットごとの方針にしたがって自動判定します。</p>
...
<p><strong>目安戦力の確認を：</strong><br>
各ダンジョンには目安戦力が表示されています。自分の戦力と大きく差がある場所では敗北リスクが高くなります。</p>
HTML,
        ],
        [
            'slug' => 'recovery_inn',
            ...
            'title' => '回復と宿屋の使い方',
            'body' => <<<'HTML'
<p>HP/SPが減った場合、街の「宿屋」でGoldを支払うと全回復できます。</p>
<p><strong>宿屋の待機：</strong><br>
宿屋を利用した後の探索待機はありません。回復後はそのまま次の冒険へ向かえます。</p>
<p><strong>その他の回復手段：</strong></p>
<ul>
    <li>補給所で毎日受け取れる回復アイテムを使う</li>
    <li>奥義や装備効果による回復を活用する</li>
</ul>
<p>探索中に街へ戻りたくない場面では、補給所の回復アイテムと使い分けましょう。</p>
HTML,
        ],
        [
            'slug' => 'equipment',
...
職業ごとに独立した経験値とランクがあります。特定のランクに達すると戦技（ジョブアーツ）を習得します。また、職業をマスターすると上位職の条件や継承戦技に関わります。</p>
<p><strong>転職のポイント：</strong></p>
<ul>
    <li>転職しても、キャラクターレベル・所持金・装備・これまでのジョブ経験値はすべて引き継ぎます</li>
    <li>過去にマスターした職業の戦技は「継承戦技」として引き続き使えます</li>
    <li>上位職・伝説職は、条件を満たすことで解放されます</li>
</ul>
<p><strong>戦技（ジョブアーツ）：</strong><br>
現在の職業で習得した戦技と、マスター済みの職業から継承した戦技を、通常戦用・ボス戦用・PvP用・レイド用にそれぞれ最大5つまでセットできます。基礎発動率は始動50%・連携55%・奥義60%です。セットごとに積極・通常・温存の方針を設定でき、戦技の発動はSPを消費します。</p>
HTML,
        ],
        [
            'slug' => 'new_dungeons',
...
HP/SPを全回復します。利用後の探索待機はありません（詳しくは「回復と宿屋の使い方」参照）。</p>
...
ダンジョン探索中に稀にヴァルモンの卵を入手できます。探索中に敗北すると卵を失います。探索を終えて街へ帰還したとき、まだ仲間にしていないヴァルモンなら孵化し、すでに仲間にしているヴァルモンなら卵のまま所持品へ入ります。</p>
