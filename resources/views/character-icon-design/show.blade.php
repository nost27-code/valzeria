                                                ...
                                                @foreach($message->attachments as $attachment)
                                                    <div class="space-y-1.5" data-attachment-number="{{ $attachmentNumbers[$attachment->id] }}">
                                                        ...
                                                        <a href="{{ route('character-icon-design.attachments.show', $attachment) }}" target="_blank" rel="noopener" class="group block overflow-hidden rounded-lg border border-slate-200 bg-slate-100">
                                                            <img src="{{ route('character-icon-design.attachments.show', $attachment) }}" alt="{{ $attachmentNumbers[$attachment->id] }}番：{{ $attachment->original_name }}" class="aspect-square w-full object-cover transition group-hover:scale-[1.02]">
                                                        </a>
                                                    </div>
                                                @endforeach
                                            </div>
