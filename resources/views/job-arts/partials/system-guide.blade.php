                    ...
                    <div class="space-y-4 p-3 sm:p-5">
                        <section class="grid gap-3 sm:grid-cols-2" aria-label="系譜とリソースの基本">
                            ...
                            <article class="rounded-xl border border-emerald-100 bg-white p-3 shadow-sm">
                                ...
                                <p class="mt-2 text-[11px] font-bold leading-relaxed text-slate-600">
                                    @if($rank5V6Enabled)
                                        SPとは別に、戦闘中だけ0〜12で貯まる系譜ごとの力です。連携は資源を消費せず、同じ系譜の固定セット順に1枚目は4、2枚目は8、3枚目は12で候補になり、4枚目以降は資源上限を超えるため発動しません。奥義は12を使い、その系譜の連携使用状況をリセットします。同じ系譜の奥義がない場合は、資源が12まで満ち、4・8・12で使える連携が一度ずつ判定済みになると、資源が0へ戻って次の周期に入ります。未判定の予定連携が残る間は12で待機し、反応型の連携は自然循環を止めません。予定連携がなく反応型だけの場合は、いずれか1枚の判定後に12まで満ちると循環します。
                                    @else
                            ...
                            <div class="mt-3 grid gap-3 sm:grid-cols-2">
                                ...
                                <article class="rounded-lg bg-slate-100 p-3">
                                    ...
                                    <p class="mt-2 text-[10px] font-bold leading-relaxed text-slate-700">
                                        1ターン内で双方が敏捷の高い順に行動し、どちらかを倒せばその時点で決着します。50ターン終了時に双方が生存している場合、最大HPに対する残りHPの割合を比べます。挑戦者の割合が防衛者より高ければ挑戦者の判定勝利、同じ割合または防衛者の方が高ければ防衛成功になります。チャンプ戦だけは最大100ターンで、実際に倒した時だけ交代します。
                                    </p>
                                </article>
                            </div>
                        </section>
