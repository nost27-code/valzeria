                ...
                <div class="mt-3 border-l-2 border-indigo-200 pl-3" data-job-art-lineage-guide-shell data-job-art-resource-guide>
                        <section data-job-art-lineage-guide="all">
                            ...
                            <p class="mt-1 text-[11px] font-bold leading-relaxed text-slate-600">
                                @if($rank5V6Enabled)
                                    多くの系譜は、始動で系譜リソースを+4します。連携は資源を消費せず、同じ系譜の固定セット順に1枚目は4、2枚目は8、3枚目は12で候補になり、4枚目以降は資源上限を超えるため発動しません。奥義は12を使い、その系譜の連携使用状況をリセットします。同じ系譜の奥義がない場合は、資源が12まで満ち、4・8・12で使える連携が一度ずつ判定済みになると、資源が0へ戻って次の周期に入ります。未判定の予定連携が残る間は12で待機し、反応型の連携は自然循環を止めません。予定連携がなく反応型だけの場合は、いずれか1枚の判定後に12まで満ちると循環します。
                                @else
