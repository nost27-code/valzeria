    ...
    >
        ...
        >
            ...
            <span class="min-w-0 flex-1">
                ...
                <span class="mt-1 block text-xs font-bold leading-relaxed text-slate-300">{{ $isLogisticsPreparation ? '探索で兵站を整え、次の開戦に備えよう。' : ($activeRaidEvent->status === 'scheduled' ? '開戦予定と報酬を確認できます。' : '全冒険者で黒天竜へ挑戦中。現在の戦況を確認できます。') }}</span>
            </span>
