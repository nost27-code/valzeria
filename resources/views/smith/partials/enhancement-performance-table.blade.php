...
<section class="mt-3 rounded-lg border border-amber-200 bg-white p-3">
    ...
    <p class="mt-1.5 text-sm leading-relaxed text-slate-700">基礎性能に対する上昇率です。低い基礎性能では、この割合より高い最低保証が適用される場合があります。装飾品は元の能力値比率で配分する別の仕組みです。+30時、単能力型はSSが合計200、SSSが300、EPICが400、全能力型はSSが各100、SSSが各150、EPICが各200になります。</p>
