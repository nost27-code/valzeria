...
>
    ...
    @if($page === 'home' || ! $membership)
        @include('livewire.partials.nation-raid-shortcut')
    @endif
    ...
    @if(!$membership || $page === 'nation-list' || ($page === 'detail' && $selectedNation))
        ...
        @elseif($page === 'detail' && $selectedNation)
            <section
                ...
                data-nation-detail-header
                data-nation-header-background="{{ $selectedNation->header_background_key }}"
            >
    ...
    @else
        ...
        >
            @include('livewire.partials.nation-profile-header', [
                ...
                'headerEyebrow' => 'MY NATION',
                'canChangeBackground' => $page === 'home' && $membership->isRuler(),
            ])
