...
| Inn | `app/Services/InnService.php`, `app/Http/Controllers/InnController.php`, `resources/views/inn/*.blade.php`, `database/migrations/*inn_rescue_streak*` | Handles paid lodging, full HP/SP block, bank-withdraw guidance, and consecutive rescue-lodging limit/refusal screens. |
