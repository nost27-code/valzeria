...
- 2026-09-01 00:00から2026-10-01 00:00までは通常闘技場の切替タブと対戦Routeが閉じ、10月1日の再開案内が表示される
- 2026-10-01 00:00以降は六英雄戦／通常闘技場の切替タブと旧対戦Routeが再び利用でき、NPC自動順位戦はSchedulerへ登録されない
