...
- 「現在の六英雄」の4ポーズ対応キャラは、各首位の画像をタップするとAlpine上でその画面内だけポーズを順送りする。閲覧Character本人が首位の場合はRoom名・名前・在位日数の枠も同じ操作にし、他人の情報枠と1ポーズ画像は冒険者カードを開く。DB上のアイコン・保存展示ポーズ・六英雄の競技データは更新しない
