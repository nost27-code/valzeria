...
- HP/SPが少ない時の「次やること」は、所持回復アイテム、無料補給、銀行Gold、救済宿泊、素材・装備売却、通常宿泊の順で、現在利用できる導線を案内する。薬草・回復薬・魔力水は街の補給所でも使用できるが、探索中は持ち込み上限を迂回できないよう戦闘結果からのみ使用する。回復量、無料補給数、宿代、Gold報酬は変更しない。
