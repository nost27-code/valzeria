...
- 神殿の転職ページでは、職業カードの詳細モーダルから特徴、職業管理の成長倍率に基づく伸びやすい能力、覚える奥義、マスター恩恵、必要条件を確認できる。転職可能な職業は詳細モーダルから既存の転職確認へ進める。
- 職業ランクは全職共通で10がマスター上限。必要職業EXPは基本職1倍、中級職2倍、上級職5倍、伝説職10倍で補正する。
