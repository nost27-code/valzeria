...
- ランク戦で順位が下がった冒険者には通知アイコンへ「ランク戦順位が低下しました」を出す。冒険者タブの「次やること」には、未完了の最前線エリアへの探索誘導、補給所で受け取れる回復アイテム、装備中装備の進化合成可否/素材不足、奥義セット不足の候補を表示する。奥義は2枠以上セット済みで奥義画面を確認した構成なら、Cost5未満でも完了扱いにする。
