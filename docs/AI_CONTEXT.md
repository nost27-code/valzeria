...
- 職業階層は8層（normal〜myth、EXP倍率1/2/5/8/10/15/22/30、転職引き継ぎ1/2・2/5・1/3）。ヴァルゼリア大陸の敵マスタは職業EXPを0〜3に収め、4以上を設定しない。職業EXPは各敵・モードの報酬設定または通常戦のLv差計算に従い、深度・亜域などの補正後も1回の報酬処理で最大3に制限する
