...
- 国家対抗レイド1位称号・王冠（2026-09-25裁定）: ヴァルグレイド個人累計1位は「黒天竜討滅の覇者」、アストラギア個人累計1位は「天墜機神討滅の覇者」。初回1位の受取済み冒険者へ前者を追加し、旧「万軍の先鋒」と保存済み報酬snapshotは維持する。街ヘッダでは有効出撃条件を満たす同率を含む現在1位へ共通王冠を表示し、最終1位は次回実開始まで保持する。次回開始後は現開催の該当者だけへ切り替え、条件未達1位から2位への繰上げはせず、六英雄冠と併記する。
